...
export async function POST(request: Request) {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      experience_points: body.experiencePoints || 0,
      subclass: body.subclass || "",
      subrace: body.subrace || "",
      armor_class: body.armorClass || 0,
      speed: body.speed || 0,
      hit_dice: body.hitDice || "",
      current_hit_points: body.currentHitPoints || 0,
      temporary_hit_points: body.temporaryHitPoints || 0,
      death_saves: body.deathSaves || { successes: 0, failures: 0 },
      saving_throw_proficiencies: body.savingThrowProficiencies || [],
      skill_proficiencies: body.skillProficiencies || [],
      ...
      spellcasting: body.spellcasting || null,
      currency: body.currency || { cp: 0, sp: 0, ep: 0, gp: 0, pp: 0 },
      age: body.age || "",
      height: body.height || "",
      weight: body.weight || "",
      eyes: body.eyes || "",
...
export async function PUT(request: Request) {
  ...
  const { data, error } = await supabase
    ...
    .update({
      ...
      subclass: body.subclass,
      subrace: body.subrace,
      armor_class: body.armorClass,
      speed: body.speed,
      hit_dice: body.hitDice,
      current_hit_points: body.currentHitPoints,
      temporary_hit_points: body.temporaryHitPoints,
      death_saves: body.deathSaves,
      saving_throw_proficiencies: body.savingThrowProficiencies,
      skill_proficiencies: body.skillProficiencies,
      languages: body.languages,
      personality_traits: body.personalityTraits,
      ...
      features: body.features,
      attacks: body.attacks,
      spellcasting: body.spellcasting,
